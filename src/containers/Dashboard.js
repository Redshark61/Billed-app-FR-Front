...
export default class {
	...
	handleEditTicket(e, bill, bills, index) {
		if (this.cardOpened === true && this.id === bill.id) {
	...
	handleShowTickets(e, bills, index) {
		if (this.counter[index] === undefined || this.index !== index) this.counter[index] = 0;
		...
		bills.forEach((bill) => {
			$(`#open-bill${bill.id}`)
				.unbind("click")
				.bind("click", (e) => this.handleEditTicket(e, bill, bills, index));
		});
